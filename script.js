    ...
    var nbrCases = liste1;
    var nbrCases2 = liste2;
   for (var i = 0; i < nbrCases.length; i++) {
    document.getElementById('recap').innerHTML += "<li>"+nbrCases[i][0]+"</li>";
    
  }
  for (var i = 0; i < nbrCases2.length; i++) {
    document.getElementById('recap').innerHTML += "<li>"+nbrCases2[i][0]+"</li>";
  }
   for (var i = 0; i < nbrCases.length; i++) {
    document.getElementById('recap2').innerHTML += "<li>"+nbrCases[i][1]+"</li>";
   
  }
  for (var i = 0; i < nbrCases2.length; i++) {
    document.getElementById('recap2').innerHTML += "<li>"+nbrCases2[i][1]+"</li>";
  }

  for (var i = 0; i < nbrCases.length; i++) {
    document.getElementById('recap3').innerHTML += "<li>"+nbrCases[i][2]+"</li>";

  }
  for (var i = 0; i < nbrCases2.length; i++) {
    document.getElementById('recap3').innerHTML += "<li>"+nbrCases2[i][2]+"</li>";
  }
